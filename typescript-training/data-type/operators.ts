...
//++a ==> pre-increment (increase the value first and execute line) ,
//  a++ ==> post-increment (execute the line with old value,then increase by 1)
...
console.log("Logical OR operator: " + (i < j || j > k)); //true
console.log("Logical NOT operator: " + !(i > j)); //true
...
let eligibleforvote:string=age>=18?'Eiligible for vote':'not Eligible for Vote'
console.log(eligibleforvote)

let num1:number = 5;
let num2:number = 10;

let maxnum:number=num1>num2?num1:num2
console.log(maxnum)
